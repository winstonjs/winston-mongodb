...
/**
 * Helper method to normalize options object.
 * @param {Object} options Loggly-like query options for this instance.
 * @returns {Object} Normalized options object
 */
MongoDB.prototype.normalizeQuery = function (options) {
  options = options || {};
  options.rows = options.rows || 10;
  options.start = options.start || 0;
  options.order = options.order || 'desc';
  options.includeIds = options.includeIds !== false;
  options.fields = options.fields || {};
  if (!options.fields._id && options.includeIds) {
