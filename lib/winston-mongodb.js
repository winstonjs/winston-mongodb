...
//
var MongoDB = exports.MongoDB = function (uri, options) {
  ...
  this.name         = 'mongodb';
  this.db           = options.db;
  this.host         = options.host || _options.hosts[0].host || 'localhost';
  this.port         = options.port || _options.hosts[0].port || mongodb.Connection.DEFAULT_PORT;
  this.collection   = options.collection || 'logs';
  this.safe         = options.safe || true;
  this.level        = options.level || 'info';
  this.silent       = options.silent || false;
  this.username     = options.username || _options.auth.user || null;
  this.password     = options.password || _options.auth.pass || null;
